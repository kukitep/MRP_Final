                ...
                <div class="col-md-4">
                    <form action="<?= base_url('bom/process') ?>" method="post">
                        ...
                        <div class="form-group" >
                            ...
                            <input type="number" name="qty" class="form-control" value="<?=$row->qty?>" ></input>
                        </div>
                        <div class="form-group" >
                        ...
                        <a href="<?= base_url("bom/insertcomponents/".$row->header_id)?>" class="btn btn-warning btn-flat">
                             <i class=""></i> Detail Components
                        </a>                         
                        </div>
