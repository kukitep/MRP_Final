...
<head>
	...
	<title>MecosinMRP | Dashboard</title>
	...
	<div class="wrapper">
		<header class="main-header">
			<a href="<?=base_url()?>dashboard" class="logo">
				<span class="logo-mini">M<b>RP</b></span>
				<span class="logo-lg">Mecosin<b>MRP</b></span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?=base_url()?>assets/dist/img/usert.jpg" class="user-image">
								<span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									<img src="<?=base_url()?>assets/dist/img/usert.jpg" class="img-circle">
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li>
						<a href="<?= base_url('manufacture') ?>"><i class="fa fa-truck"></i> <span>Manufacturing Order</span></a>
					</li>
					<li>
						<a href="<?= base_url('bom') ?>"><i class="fa fa-truck"></i> <span>Bill of Materials</span></a>
					</li>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2023 <a href="https://mecosinindonesia.com">Mecosin Indonesia</a>.</strong> All rights reserved.
		</footer>
